...
echo '
                                                    ...
                                                    <div class="rowItem  col-md-5  btTextCenter">
                                                        <div class="rowItemContent">
                                                            <div class="btMediaBox">
                                                                <div class="bpbItem">
                                                                    <a href="buyselllanddetail.php?q='.$row['id'].'"><img src="images/olx/'.$row['img'].'"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
   ...
   <span>
                                                                ...
                                                                <a href="buyselllanddetail.php?q='.$row['id'].'" class="btArticleCategory cat-item-18">'.$row['cat'].'</a>
                                                                ...
                                                                <a href="buyselllanddetail.php?q='.$row['id'].'" class="btArticleCategory cat-item-14">'.$row['property'].'</a>
                                                                ...
                                                                <div class="dash">
                                                                    <h3><span class="headline"><a href="buyselllanddetail.php?q='.$row['id'].'">'.$row['productname'].' </a></span></h3></div>
