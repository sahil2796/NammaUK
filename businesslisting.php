...
$result = mysqli_query($con,"SELECT * FROM bicategory WHERE maincatid=$var and status = 1 ORDER BY id desc");
                                                    ...
                                                    <div class="rowItem  col-md-5  btTextCenter">
                                                        <div class="rowItemContent">
                                                            <div class="btMediaBox">
                                                                <div class="bpbItem">
                                                                    <a href="businesslistingdetail.php?q='.$row['id'].'"><img src="images/bi/'.$row['img'].'"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="rowItem btTextLeft  col-md-7 ">
                                                        <div class="rowItemContent">
                                                            <header class="header btClear medium">
                                                                ...
                                                                <div class="dash">
                                                                    <h3><span class="headline"><a href="businesslistingdetail.php?q='.$row['id'].'">'.$row['businessname'].'</a></span></h3></div>
...
'.$row['street'].', '.$row['area'].', '.$row['landmark'].', '.$row['taluka'].', '.$row['city'].' - '.$row['pincode'].' 
  ...
  <i style="font-size:18px;margin:8px" class="fa fa-chrome" aria-hidden="true"></i> '.$row['website'].'                                                                                                                        
  ...
  <a style="background-color: #25d366;
    border-radius: 50px;color:white" href="whatsapp://send?text=http://amarprerana.org/nammauk/newsdetailspage.php?q='.$_GET['q'].'" target="_blank" data-ico-fa="&#xf232;" class="btIcoHolder"></a>
                                                ...
                                                <div class="rowItem col-md-6 col-ms-12 btReadArticle btMiddleVertical btTextRight">
                                                    <div class="rowItemContent"><a href="" class="btBtn btnRightPosition btContinueReading btnFilledStyle btnAccentColor btnExtraSmall btnNormalWidth btnIco"><span class="btnInnerText">Call us </span><span class="btIco ">  <i style="" class="fa fa-phone" aria-hidden="true"></i></span></a></div>
                                                </div>
                                            </div>
