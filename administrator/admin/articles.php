                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="btn-group">
                                            <div class="buttonexport" id="buttonlist">
                                                <a class="btn btn-add" href="articlesadd.php"> <i class="fa fa-plus"></i> Add Articles 
                                                </a>
...
if(isset($_GET['del']))
{
    $SQL = $con->query("DELETE FROM articles WHERE id=".$_GET['del']);
...
echo '     <tbody>
    ...
    <td><img width="50px" src="../../images/articles/'.$row['img'].'" /></td>
    <td>'.$row['articlescategory'].'</td>
  <td>'.$row['title'].'</td>
 ...
 <td>'.$row['priority'].'</td> 
  ...
  <td>'.$row['postedby'].'</td> 
  <td>'.$row['datee'].'</td>
<td> <a href="articleaddphoto.php?q='.$row['id'].'"><b>Add Images</b></a></td>
