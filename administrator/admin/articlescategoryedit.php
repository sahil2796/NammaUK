                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonlist"> 
                              ...
                              <i class="fa fa-list"></i>  Articles Category List </a>  
                           </div>
                        </div>
...
if(isset($_GET['edit']))
{
$result = mysqli_query($con,"SELECT * FROM articlescategory WHERE id=".$_GET['edit']);
...
{
$result = mysqli_query($con,"UPDATE articlescategory SET type='".$_POST['type']."'
 WHERE id=".$_GET['edit']);
  ...
  ?>
                ...
                window.location.href='articlescategory.php';
                </script>
                <?php
