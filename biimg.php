...
if ($db->connect_error) {
    ...
    if(!empty(array_filter($_FILES['files']['name']))){
        ...
        if(!empty($insertValuesSQL)){
            ...
            $insert = $db->query("INSERT INTO biimages (idd,file_name, uploaded_on) VALUES $insertValuesSQL");
            if($insert){
...
if(isset($_GET['del']))
{
    $SQL = $con->query("DELETE FROM biimages WHERE id=".$_GET['del']);
...
$result = mysqli_query($con,"SELECT * FROM biimages where idd=$abc");
...
echo '       <div class="rowItem col-md-3 col-sm-6 col-ms-12 btTextLeft animate animate-fadein inherit" data-width="3">
                                                    <div class="rowItemContent">
                                                        ...
                                                        <header class="header btClear medium  regular">
                                                            <div class="dash">
<img width="200px" src="images/bi/'.$row['file_name'].'" />
