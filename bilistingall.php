...
include"db.php";
$result = mysqli_query($con,"SELECT * FROM bicategory where status=1 ORDER BY id desc");
                                                    ...
                                                    <div class="rowItem btTextLeft  col-md-7 ">
                                                        <div class="rowItemContent">
                                                            <header class="header btClear medium">
                                                                ...
                                                                <span><span class="btArticleCategories">

                                                                <a href="businesslistingdetail.php?q='.$row['id'].'" class="btArticleCategory cat-item-14">'.$row['subcategory'].'</a>
...
'.$row['street'].', '.$row['area'].', '.$row['landmark'].', '.$row['taluka'].', '.$row['city'].' - '.$row['pincode'].' 
  ...
  <i style="font-size:18px;margin:8px" class="fa fa-chrome" aria-hidden="true"></i> '.$row['website'].'                                                                                                                        
                                                ...
                                                <div class="rowItem col-md-6 col-ms-12 btReadArticle btMiddleVertical btTextRight">
                                                    <div class="rowItemContent"><a href="" class="btBtn btnRightPosition btContinueReading btnFilledStyle btnAccentColor btnExtraSmall btnNormalWidth btnIco"><span class="btnInnerText">BEST DEAL </span><span class="btIco "><span  data-ico-fa="&#xf061;" class="btIcoHolder"></span></span></a></div>
                                                </div>
                                            </div>
