                                                                            ...
                                                                            <div class="rowItemContent">
                                                                               <div class="btClear btSeparator topSemiSpaced noBorder">
                                                                                ...
                                                                                <header class="header btClear large  regular">
                                                                                    ...
                                                                                    <div class="dash">
                                                                                        <h2><span class="headline">Sell Your Products</span></h2></div>
...
$save=mysqli_query($con,"INSERT INTO olx (id,img,cat,productname,model,brand,taluka,price,description,cname,mobile) VALUES ('$id','$img','$cat','$productname','$model','$brand','$taluka','$price','$description','$cname','$mobile')");
...
<option value="mobile">Mobile </option>
 ...
 <br>
               ...
               <div class="form-group">
                 ...
                 <input   type="text" placeholder="Enter your Product Name" name="productname" required="" /> 
             </div>  
 ...
 <br> 
   ...
   <div class="form-group">
                  <label>Model</label>
                 <input   type="text" placeholder="Enter your Model" name="model" required="" /> 
             </div>  
 ...
 <br> 
         ...
         <div class="form-group">
                  <label>Brand</label>
                 <input   type="text" placeholder="Enter your Brand" name="brand" required="" /> 
             </div>  
