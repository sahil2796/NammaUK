                                    ...
                                    <div class="btArticleSideinfo">
                                        ...
                                        <div class="btRelatedPosts">
                                            ...
                                            <div class="rowItemContent">
                                              ...
                                              <a style="text-align: center;width:100%" href="olxsellform.php" class="btBtn btnRightPosition btContinueReading btnFilledStyle btnAccentColor btnExtraSmall btnNormalWidth btnIco">
...
echo '   
 <div class="btSuperTitle">
   <span>
                                                                ...
                                                                <a href="" class="btArticleCategory cat-item-14">'.$row['brand'].'</a>
 ...
 <div class="boldRowInner">
                                                <div style="padding:0px" class="rowItem col-md-6 col-ms-12 btShareArticle btMiddleVertical btTextLeft">
                                                      <div style="   margin-bottom:0px; font-size: 2.125em;" class="btArticleExcerpt">'.$row['productname'].' [ '.$row['model'].' ]</div>
                                                </div>
...
<br>
   ...
   <i style="font-size:22px;margin:8px" class="fa fa-map-marker" aria-hidden="true"></i> 
 '.$row['taluka'].' </p>
