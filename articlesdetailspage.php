...
$result = mysqli_query($con,"SELECT * FROM articleimages where idd=$var");

while($row = mysqli_fetch_array($result))
{
echo '
   <div class="bpbItem"><img src="images/articles/' . $row['file_name'] . '" alt="post_11"></div>
...
$result = mysqli_query($con,"UPDATE articles SET hits=hits+1 WHERE id=$var");

$result = mysqli_query($con,"SELECT * FROM articles WHERE id=$var");
while($row = mysqli_fetch_array($result))
{
...
echo '   
                                        ...
                                        <header class="header btClear extralarge">
                                            <div class="btSuperTitle"><span><span class="btArticleCategories"><a href="" class="btArticleCategory cat-item-9">'.$row['articlescategory'].'</a>
 ...
 <br> <br>
  ...
  <p>'.$row['ldescription'].'</p>
                                              ...
                                              <a href="https://www.facebook.com/sharer.php?u="  target="_blank" data-ico-fa="&#xf09a;" class="btIcoHolder"></a>

                                              </span>

                                              <span class="btIco btIcoFilledType btIcoSmallSize btIcoTwitter"><a href="http://twitter.com/share?text='.$row['title'].'&url=" target="_blank" data-ico-fa="&#xf099;" class="btIcoHolder"></a></span>

                                              <span class="btIco btIcoFilledType btIcoSmallSize btIcoLinkedin"><a href="https://www.linkedin.com/shareArticle?url=" target="_blank" data-ico-fa="&#xf0e1;" class="btIcoHolder"></a></span>

                                              <span class="btIco btIcoFilledType btIcoSmallSize btIcoGooglePlus"><a href="https://plus.google.com/share?url=" target="_blank" data-ico-fa="&#xf0d5;" class="btIcoHolder"></a></span>
...
$result = mysqli_query($con,"SELECT * FROM articlevideos where idd=$var");
...
echo '
  ...
  <source src="images/articles/'.$row['file_name'].'" type="video/mp4">
...
<section class="boldSection gutter bottomMediumSpaced btAboutAutorSection">
	...
	<section class="boldSection btSinglePostBanner gutter bottomMediumSpaced">
		<div class="port">
			<div class="boldRow btTextLeft" id="boldSiteFooterWidgetsRow"><div class="btPostBanner widget_bt_banner_widget"><div class="bt_banner" ><a href="https://themeforest.net/item/food-haus-restaurant-wordpress-theme/19441479?ref=BoldThemes" target="_blank"><img src="wp-content/uploads/sites/2/2017/03/Food-haus-970x90-banner.jpg" /></a></div></div>	
			</div>
		</div>
	</section>
